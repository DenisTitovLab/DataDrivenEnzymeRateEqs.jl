...
Keq = 20_000.0
enzyme_parameters = (; substrates=substrates, products=products, regulators=regulators, Keq=Keq, oligomeric_state=rand(1:4), rate_equation_name=:rand_enz_rate_equation)
