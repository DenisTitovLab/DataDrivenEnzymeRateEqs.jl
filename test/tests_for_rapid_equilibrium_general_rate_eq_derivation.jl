...
#test `@derive_rapid_equilibrium_rate_eq` generated `rate_equation::Function` using PKM2 data
PKM2_enzyme = (;
    substrates = [:PEP, :ADP],
...
metab_names, param_names = @derive_general_rapid_equilibrium_rate_eq(PKM2_enzyme)
